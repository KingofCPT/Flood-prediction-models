...
# 保持原有的load_and_preprocess_data和apply_pca函数不变
...
def apply_pca(X_train, X_val, X_test, explained_variance_threshold=0.8):
...
def main():
    ...
    model_types = ["XGBoost", "RandomForest", "LGBM", "CatBoost"]
